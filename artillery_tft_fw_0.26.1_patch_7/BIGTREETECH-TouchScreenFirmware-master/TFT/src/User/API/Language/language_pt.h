...
#define _LANGUAGE_PT_H_
    ...
    #define PT_EEPROM_RESET           "Reset"
    #define PT_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define PT_DEFAULT                "Default"
    #define PT_POINT_5                "Ponto 5"
    #define PT_XY_OFFSET              "XY offset"
    #define PT_XY_UNLOCK              "Desbloquear XY"
    #define PT_TUNING                 "Tuning"
    #define PT_PID                    "P.I.D."
    #define PT_PID_TITLE              "P.I.D. autotune"
    #define PT_PID_START              "Start"
    #define PT_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define PT_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define PT_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
