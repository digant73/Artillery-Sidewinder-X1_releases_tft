...
#define _LANGUAGE_DU_H_
    ...
    #define DU_EEPROM_RESET           "Reset"
    #define DU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define DU_DEFAULT                "Default"
    #define DU_POINT_5                "Punt 5"
    #define DU_XY_OFFSET              "XY offset"
    #define DU_XY_UNLOCK              "Ontgrendel XY"
    #define DU_TUNING                 "Tuning"
    #define DU_PID                    "P.I.D."
    #define DU_PID_TITLE              "P.I.D. autotune"
    #define DU_PID_START              "Start"
    #define DU_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define DU_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define DU_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
