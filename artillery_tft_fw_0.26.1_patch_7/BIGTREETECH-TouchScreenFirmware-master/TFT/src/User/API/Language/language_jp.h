...
#define _LANGUAGE_JP_H_
    ...
    #define JP_EEPROM_RESET           "Reset"
    #define JP_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define JP_DEFAULT                "Default"
    #define JP_POINT_5                "Point 5"
    #define JP_XY_OFFSET              "XY offset"
    #define JP_XY_UNLOCK              "Unlock XY"
    #define JP_TUNING                 "Tuning"
    #define JP_PID                    "P.I.D."
    #define JP_PID_TITLE              "P.I.D. autotune"
    #define JP_PID_START              "Start"
    #define JP_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define JP_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define JP_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
