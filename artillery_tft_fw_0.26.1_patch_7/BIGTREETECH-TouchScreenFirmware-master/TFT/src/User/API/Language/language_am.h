...
#define _LANGUAGE_AM_H_
    ...
    #define AM_EEPROM_RESET           "Reset"
    #define AM_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define AM_DEFAULT                "Default"
    #define AM_POINT_5                "Point 5"
    #define AM_XY_OFFSET              "XY offset"
    #define AM_XY_UNLOCK              "Unlock XY"
    #define AM_TUNING                 "Tuning"
    #define AM_PID                    "P.I.D."
    #define AM_PID_TITLE              "P.I.D. autotune"
    #define AM_PID_START              "Start"
    #define AM_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define AM_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define AM_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
