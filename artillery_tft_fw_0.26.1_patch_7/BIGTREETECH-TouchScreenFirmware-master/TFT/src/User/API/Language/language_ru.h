...
#define _LANGUAGE_RU_H_
    ...
    #define RU_EEPROM_RESET           "Reset"
    #define RU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define RU_DEFAULT                "Default"
    #define RU_POINT_5                "Точка 5"
    #define RU_XY_OFFSET              "XY offset"
    #define RU_XY_UNLOCK              "Разблокировать XY"
    #define RU_TUNING                 "Tuning"
    #define RU_PID                    "P.I.D."
    #define RU_PID_TITLE              "P.I.D. autotune"
    #define RU_PID_START              "Start"
    #define RU_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define RU_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define RU_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
