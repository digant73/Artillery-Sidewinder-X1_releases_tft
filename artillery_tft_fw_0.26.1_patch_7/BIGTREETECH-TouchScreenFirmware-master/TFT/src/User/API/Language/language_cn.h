...
#define _LANGUAGE_CN_H_
    ...
    #define CN_EEPROM_RESET           "Reset"
    #define CN_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define CN_DEFAULT                "Default"
    #define CN_POINT_5                "第五点"
    #define CN_XY_OFFSET              "XY offset"
    #define CN_XY_UNLOCK              "解锁XY"
    #define CN_TUNING                 "Tuning"
    #define CN_PID                    "P.I.D."
    #define CN_PID_TITLE              "P.I.D. autotune"
    #define CN_PID_START              "Start"
    #define CN_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define CN_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define CN_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
