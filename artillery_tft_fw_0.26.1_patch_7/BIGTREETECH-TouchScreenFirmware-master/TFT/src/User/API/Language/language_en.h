...
#define _LANGUAGE_EN_H_
    ...
    #define EN_EEPROM_RESET           "Reset"
    #define EN_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define EN_DEFAULT                "Default"
    #define EN_POINT_5                "Point 5"
    #define EN_XY_OFFSET              "XY offset"
    #define EN_XY_UNLOCK              "Unlock XY"
    #define EN_TUNING                 "Tuning"
    #define EN_PID                    "P.I.D."
    #define EN_PID_TITLE              "P.I.D. autotune"
    #define EN_PID_START              "Start"
    #define EN_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define EN_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define EN_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
