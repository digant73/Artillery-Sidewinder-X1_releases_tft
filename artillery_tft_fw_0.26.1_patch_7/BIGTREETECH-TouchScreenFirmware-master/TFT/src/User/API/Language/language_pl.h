...
#define _LANGUAGE_PL_H_
    ...
    #define PL_EEPROM_RESET           "Reset"
    #define PL_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define PL_DEFAULT                "Default"
    #define PL_POINT_5                "Punkt 5"
    #define PL_XY_OFFSET              "XY offset"
    #define PL_XY_UNLOCK              "Odblokuj XY"
    #define PL_TUNING                 "Tuning"
    #define PL_PID                    "P.I.D."
    #define PL_PID_TITLE              "P.I.D. autotune"
    #define PL_PID_START              "Start"
    #define PL_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define PL_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define PL_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
