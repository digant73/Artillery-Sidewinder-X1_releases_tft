...
#define _LANGUAGE_HU_H_
    ...
    #define HU_EEPROM_RESET           "Reset"
    #define HU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define HU_DEFAULT                "Default"
    #define HU_POINT_5                "5. pont"
    #define HU_XY_OFFSET              "XY offset"
    #define HU_XY_UNLOCK              "Kinyit XY"
    #define HU_TUNING                 "Tuning"
    #define HU_PID                    "P.I.D."
    #define HU_PID_TITLE              "P.I.D. autotune"
    #define HU_PID_START              "Start"
    #define HU_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define HU_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define HU_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
