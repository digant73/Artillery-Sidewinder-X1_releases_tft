...
#define _LANGUAGE_SK_H_
    ...
    #define SK_EEPROM_RESET           "Reset"
    #define SK_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define SK_DEFAULT                "Default"
    #define SK_POINT_5                "Bod 5"
    #define SK_XY_OFFSET              "XY offset"
    #define SK_XY_UNLOCK              "Odomknite XY"
    #define SK_TUNING                 "Tuning"
    #define SK_PID                    "P.I.D."
    #define SK_PID_TITLE              "P.I.D. autotune"
    #define SK_PID_START              "Start"
    #define SK_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define SK_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define SK_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
