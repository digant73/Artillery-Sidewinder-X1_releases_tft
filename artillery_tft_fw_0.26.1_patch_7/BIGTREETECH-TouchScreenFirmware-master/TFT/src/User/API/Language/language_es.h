...
#define _LANGUAGE_ES_H_
    ...
    #define ES_EEPROM_RESET           "Reset"
    #define ES_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define ES_DEFAULT                "Default"
    #define ES_POINT_5                "Punto 5"
    #define ES_XY_OFFSET              "XY offset"
    #define ES_XY_UNLOCK              "Desbloquear XY"
    #define ES_TUNING                 "Tuning"
    #define ES_PID                    "P.I.D."
    #define ES_PID_TITLE              "P.I.D. autotune"
    #define ES_PID_START              "Start"
    #define ES_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define ES_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define ES_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
