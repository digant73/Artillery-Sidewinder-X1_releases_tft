...
#define _LANGUAGE_CZ_H_
    ...
    #define CZ_EEPROM_RESET           "Reset"
    #define CZ_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define CZ_DEFAULT                "Default"
    #define CZ_POINT_5                "Bod 5"
    #define CZ_XY_OFFSET              "XY offset"
    #define CZ_XY_UNLOCK              "Odemkněte XY"
    #define CZ_TUNING                 "Tuning"
    #define CZ_PID                    "P.I.D."
    #define CZ_PID_TITLE              "P.I.D. autotune"
    #define CZ_PID_START              "Start"
    #define CZ_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define CZ_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define CZ_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
