...
#define _LANGUAGE_FR_H_
    ...
    #define FR_EEPROM_RESET           "Reset"
    #define FR_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define FR_DEFAULT                "Default"
    #define FR_POINT_5                "Point 5"
    #define FR_XY_OFFSET              "XY offset"
    #define FR_XY_UNLOCK              "Déverrouiller XY"
    #define FR_TUNING                 "Tuning"
    #define FR_PID                    "P.I.D."
    #define FR_PID_TITLE              "P.I.D. autotune"
    #define FR_PID_START              "Start"
    #define FR_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define FR_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define FR_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
