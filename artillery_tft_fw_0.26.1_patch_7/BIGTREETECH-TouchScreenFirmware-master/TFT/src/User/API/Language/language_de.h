...
#define _LANGUAGE_DE_H_
    ...
    #define DE_EEPROM_RESET           "Reset"
    #define DE_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define DE_DEFAULT                "Default"
    #define DE_POINT_5                "Punkt 5"
    #define DE_XY_OFFSET              "XY offset"
    #define DE_XY_UNLOCK              "Schalte XY frei"
    #define DE_TUNING                 "Tuning"
    #define DE_PID                    "P.I.D."
    #define DE_PID_TITLE              "P.I.D. autotune"
    #define DE_PID_START              "Start"
    #define DE_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define DE_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define DE_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
