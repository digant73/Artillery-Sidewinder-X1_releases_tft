...
#define _LANGUAGE_IT_H_
    ...
    #define IT_EEPROM_RESET           "Reset"
    #define IT_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    #define IT_DEFAULT                "Default"
    #define IT_POINT_5                "Punto 5"
    #define IT_XY_OFFSET              "XY offset"
    #define IT_XY_UNLOCK              "Sblocca XY"
    #define IT_TUNING                 "Tuning"
    #define IT_PID                    "P.I.D."
    #define IT_PID_TITLE              "P.I.D. autotune"
    #define IT_PID_START              "Start"
    #define IT_PID_START_DIALOG       "P.I.D. autotune will be started. " \
                                      "It can take few minutes. Continue?"
    #define IT_PID_START_INFO         "P.I.D. autotune in progress!       " \
                                      "                                   " \
                                      "DO NOT touch the screen until completed (green LED on)!"
    #define IT_PID_START_INFO_EXTRA   "Touch the screen when green LED on"
